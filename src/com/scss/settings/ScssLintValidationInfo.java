...
public class ScssLintValidationInfo {
    public static final String LINK_TEMPLATE = "{{LINK}}";
    private static final Logger LOG = Logger.getInstance(ScssLintValidationInfo.class);
    private final JTextComponent textComponent;
    private final String errorHtmlDescription;
    private final String linkText;

    public ScssLintValidationInfo(@Nullable JTextComponent textComponent, @NotNull String errorHtmlDescriptionTemplate, @NotNull String linkText) {
